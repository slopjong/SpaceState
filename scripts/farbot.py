...
class FarBot(irc.IRCClient):
    """A logging IRC bot."""

    nickname = "FarBot"
    password = "Fhearsaid"
    realname = "Farset Labs"
...
class FarBotFactory(protocol.ClientFactory):
    """A factory for FarBots.
...
class hackerspace():
    ...
    def __init__(self):
        ...
        self.name = "Farset Labs"
        self.username = "FarsetLabs"
        self.irc_net = "irc.freenode.net"
        self.irc_chan = "#FarsetLabs"
        self.json_file = "/opt/etc/farsetlabs.json"
        self.log_file = "/opt/etc/farsetlabs.log"
